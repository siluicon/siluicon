...
int64 nChainStartTime = 1499212800;
...
const string strMessageMagic = "ICon signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
        nSubsidy = 150000000 * COIN;	// 1 billion coins, that all pow coins
...
//    int nYear=nHeight/YEARLY_BLOCKCOUNT;
//    if(nYear<10)
//        nRewardCoinYear = (10-nYear) * MAX_MINT_PROOF_OF_STAKE;
//    else
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ICon
    bool fStrictPayToScriptHash = true; // Always active in ICon
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ICon",CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1499212800;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13608386;
        ...
        assert(block.hashMerkleRoot == uint256("d452a33573304fed387a3f04cee2ab6dbf5701f0d6bc61e1dfcb0362af413cbf"));
