...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ICon"+ FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"seed2", "dnsseed1.siluicon.com"},
    {"seed3", "dnsseed2.siluicon.com"},
    {"seed4", "dnsseed3.siluicon.com"},
    {"seed5", "dnsseed3.siluicon.com"},
    {"seed6", "dnsseed6.siluicon.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ICon is probably already running."), addrBind.ToString().c_str());
        else
